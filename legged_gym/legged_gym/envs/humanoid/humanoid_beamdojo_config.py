...
class HumanoidBEAMDOJOCfg(LeggedRobotCfg):
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        class scales:
            ...
            lin_vel_z = -0.5
            ang_vel_xy = -0.025
            orientation = -0.5  # 从-1.5降低，减少过强的姿态稳定压力，允许更多动态步态
            action_rate = -0.01
            ...
            feet_distance_lateral = 0.1  # 从0.5降低，弱化横向距离稳定性要求
            knee_distance_lateral = 0.2  # 从1.0降低，弱化膝关节横向距离稳定性
            feet_ground_parallel = 0.0  # 从-2.0改为0，关闭此奖励（强烈抑制交替步态）
